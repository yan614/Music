...
public class BottomFragment extends Fragment implements View.OnClickListener{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        filter.addAction("com.example.music.musictime");
    ...
    public View onCreateView(LayoutInflater inflater,ViewGroup container,Bundle savedInstanceState){
        ...
        mSeekBar.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onStopTrackingTouch(SeekBar seekBar) {
                ...
                updateUI();
                Intent intent = new Intent(seekBar.getContext(),MusicService.class);
    ...
    public static void updateUI(){
        ...
        if (PlayingListLab.isPlaying){
            playPause.setBackgroundResource(R.mipmap.ic_pause_white);
        }else{
            playPause.setBackgroundResource(R.mipmap.ic_play_white);
        }
        switch (PlayingListLab.playStatus){
            case PlayingListLab.ORDER:
                playStatus.setBackgroundResource(R.mipmap.ic_order);
                break;
            case PlayingListLab.REPEAT_ONCE:
                playStatus.setBackgroundResource(R.mipmap.ic_repeat);
                break;
            case PlayingListLab.RANDOM:
                playStatus.setBackgroundResource(R.mipmap.ic_random);
                break;
        }
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()){
            case R.id.prev_button:
                ...
                PlayingListLab.isPlaying = true;
                updateUI();
                Intent intent_prev = new Intent(getActivity(), MusicService.class);
            ...
            case R.id.next_button:
                ...
                PlayingListLab.isPlaying = true;
                updateUI();
                Intent intent_next = new Intent(getActivity(), MusicService.class);
            ...
            case R.id.play_pause_button:
                ...
                updateUI();
                Intent intent_play_pause = new Intent(getActivity(), MusicService.class);
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            switch (type){
                ...
                case MusicService.CURRENT_TIME_TYPE:
                    ...
                    break;
                case MusicService.NEXT_MUSIC:
                    PlayingListLab.get().next();
                    PlayingListLab.isPlaying = true;
                    updateUI();
                    Intent intent_next = new Intent(mContext, MusicService.class);
                    intent_next.putExtra("path",PlayingListLab.get().getCurrentMusic().getUrl());
                    intent_next.putExtra("MSG", PlayerMsg.PLAY_MSG);
